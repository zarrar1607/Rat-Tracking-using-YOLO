...
int main() {
    ...
    try {
        ...
        std::string model_path = "/mnt/c/Zarrar 2023/Programming/Yolo/ultralytics/yolov8s.torchscript";
        ...
        cv::Mat image = cv::imread("/mnt/c/Zarrar 2023/Programming/Yolo/ultralytics/ultralytics/bus.jpg");
        cv::Mat input_image;
